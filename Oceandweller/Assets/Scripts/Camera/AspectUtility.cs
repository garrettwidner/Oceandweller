...
//Sets the camera rect to create some pillarbox/letterbox bands according to the proportion 
//between the current and desired aspect ratio. It will also add a background camera to fill these 
//black bands and guarantee screen refreshing for these areas.
public class AspectUtility : MonoBehaviour
{
    ...
    private void UpdateCamera()
    {
        ...
        if (currentAspectRatio > ResolutionManager.TargetAspectRatio)
        {
            ...
            print("Target aspect ratio: " + ResolutionManager.TargetAspectRatio);
